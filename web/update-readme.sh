#!/bin/bash
# Description: Generate index.md files for use with MDWiki. Run it in a doc/notes/blog directory of your choice.

# Copyright (C) 2015 nodiscc <nodiscc@gmail.com>
# Copyright (C) 2015 Ricardo Ferreira <https://launchpad.net/~ricardofcf>
