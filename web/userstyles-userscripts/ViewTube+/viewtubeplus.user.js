...
// =====AlkislarlaYasiyorum===== //
  ...
  if (!ayPlayerWindow) {
    ...
    /* Get Video */
    var ayVideo = getMyContent (page.url, 'streamurl:"(.*?)"', false);
      
    /* My Player Window */
    var myPlayerWindow = createMyElement ('div', '', '', '', '');
    styleMyElement (myPlayerWindow, {position: 'relative', width: '640px', height: '360px', backgroundColor: '#E6E9D4', margin: '0px auto'});
    ...
    if (ayVideo) {
      ...
      player = {'playerSocket': ayPlayerWindow, 'playerWindow': myPlayerWindow, 'videoList': ayVideoList, 'videoPlay': ayDefaultVideo, 'videoThumb': ayVideoThumb, 'playerWidth': 640, 'playerHeight': 360};
      feature['definition'] = false;
      feature['container'] = false;
      feature['widesize'] = false;
      createMyPlayer ();
